...
import { getPINs } from '../../../src/kyu/4/observed-pin-again'
...
function assertSamePins(testSubject: string, observedToPins: PinExpectations): void {
