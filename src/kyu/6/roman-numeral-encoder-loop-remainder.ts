...
function checkForLessThanPlace(number: number, numericPlace: number): string {
  ...
  if (
    ...
    console.log(
      ...
      BASE_10_ROMAN_NUMERAL[numericPlace] + BASE_10_ROMAN_NUMERAL[numericPlace + number]
    )
    return BASE_10_ROMAN_NUMERAL[numericPlace] + BASE_10_ROMAN_NUMERAL[numericPlace + number]
    // } else if (number >= 5) {
    ...
    console.log(`🚀 ~ checkForLessThanPlace ~ placeTimesFiveNumeral:`, placeTimesFiveNumeral)
    const numberMinusFive = multiplyRomanNumerals(BASE_10_ROMAN_NUMERAL[numericPlace], number - 5)
    console.log(`🚀 ~ checkForLessThanPlace ~ numberMinusFive:`, numberMinusFive)
