 ...
 * @returns
 */
function getBaseNumber(leadingNumber, remainder) {
 ...
 * @returns
 */
function getRemainder(wholeNumber, leadingNumber) {
  return wholeNumber % leadingNumber;
}
function getLeadingNumber(numerator) {
 ...
 * @returns
 */
function getNumericPlace(number) {
 ...
 * @returns
 */
function getBaseTenToNumber(number) {
 ...
 * @returns
 */
function getRomanNumeral(originalNumber, numericPlace) {
 ...
 * @returns
 */
function checkForLessThanPlace(number, numericPlace) {
...
function multiplyRomanNumerals(romanNumeral, multiplier) {
